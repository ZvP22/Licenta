<?php include('header.php'); ?>
		<div class="content">
			...
			<div class="double-range">
				...
				<form method="POST" name="slider" action="imac.php">
		...
		<div class="styled-select slate">
			...
			<form method="POST" action="imac.php">
				<select name="sort">
		...
		<div class="product-grid product-grid--flexbox">
			<div class="product-grid__wrapper">
				...
				if(isset($_POST['sort'])){
					...
					if($var1 == "nume"){
						$sql =	" SELECT * FROM products WHERE p_type LIKE 'imac' ORDER BY p_name ASC" ;


					}else if($var1 == "pret"){
						$sql =	" SELECT * FROM products WHERE p_type LIKE 'imac' ORDER BY p_price ASC" ;


					}else if($var1 == "pretD"){
						$sql =	" SELECT * FROM products WHERE p_type LIKE 'imac' ORDER BY p_price DESC" ;
					...
					$sql = " SELECT * FROM products WHERE p_type LIKE 'imac' AND p_price BETWEEN '$min' AND '$max' ORDER BY p_price ASC";
				}else{ 

					$sql = " SELECT * FROM products WHERE p_type LIKE 'imac'"; 
				...
				while($r = mysqli_fetch_assoc($res)) 
				{
					...
					<span  class="product-grid__btn product-grid__add-to-cart"><i class="fa fa-cart-arrow-down"></i> <a href="addtocart.php?id='.$r['p_id'].'&pg=imac">Adauga in cos</a></span>
