...
<body>
  ...
  <input class="search-btn" type="text" name="search" placeholder="Cauta">
	...
	<form method="POST" action="sort.php" name="select">
  <select>
  	<option>--</option>
    <option value="p_name">Nume</option>
    <option value="p_price">Pret crescator</option>
    <option value="p_priceD" >Pret descrescator</option>
  </select>
</form>
</div>	
<br/>
